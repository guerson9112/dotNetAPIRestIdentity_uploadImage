...
namespace ApiEcommerce.Controllers.V1
{
    ...
    //[EnableCors(PolicyNames.AllowSpecificOrigin)] //a nivel de controlador
    public class CategoriesController : ControllerBase
    {
        ...
        //[EnableCors(PolicyNames.AllowSpecificOrigin)]  //a nivel de metodo
        ...
        public IActionResult GetCategory(int id)
        {
            ...
            //var notFoundrMessage = $"La categoría con el id {id} no existe";
            if (category == null)
            {
